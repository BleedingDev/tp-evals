...
QA: low dimension score needs review reason`,
  ...
  },
  {
    ...
    task: "Zkontrolujte intent, slots, confidence a missing fields",
    items: [
      "Intent určuje další krok v aplikaci",
      "Slot je hodnota z dotazu, ne domněnka",
      "Chybějící slot patří do missing fields",
      "Vymyšlená hodnota je release risk",
      "Confidence odděluje continue od review",
    ],
