...
Ve výstupu nejdřív hledejte `rowStatus`. Hodnota `broken` říká, že checker našel rozbitý dataset row. Potom čtěte `fixPlan`: vlevo je rozbitý field, vpravo minimální oprava.
